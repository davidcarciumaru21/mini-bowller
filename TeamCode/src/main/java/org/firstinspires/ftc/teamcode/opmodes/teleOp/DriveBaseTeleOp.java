...
@TeleOp(name = "DriveBase", group = "Use-Teleops")
public class DriveBaseTeleOp extends OpMode{
    ...
    //======================Drive and localizer=====================
    MecanumDrive drive;
    ThreeDeadWheelLocalizer driveLocalizer;
    ...
    public void init() {
        ...
        try (FileReader reader = new FileReader(file)) {
            ...
            allianceColor = AllianceColor.valueOf(json.get("color").getAsString());

            startPose = new Pose2d(startPoseX, startPoseY, startPoseHeading);
        } catch (IOException e) {
            startPose = new Pose2d(0, 0, 0);
            allianceColor = AllianceColor.NONE;
        }
        ...
        driveLocalizer = new ThreeDeadWheelLocalizer(hardwareMap, MecanumDrive.PARAMS.inPerTick, startPose);
    ...
    public void loop() {
        ...
        TelemetryMethods.displayCodeVersion(telemetry, dashboardTelemetry,"10.28.25.3.51");
        telemetry.addLine("-----------------------------");
        telemetry.update();
    }
    ...
    public void stop() {
        ...
        telemetry.addLine("-----------------------------");
        telemetry.addLine("The robot stopped");
        telemetry.addLine("-----------------------------");
    }
}
